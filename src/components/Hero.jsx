...
const Hero = () => {
  return (
    <div id='about' className="relative">
        ...
        alt="Hero" 
        />
        <h1 className="hidden md:block absolute text-6xl text-white border-2 top-[35%] left-[11%] py-10 pl-10 pr-16 font-light">IMMERSIVE <br />EXPERIENCES <br />THAT DELIVER</h1>
